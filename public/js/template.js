(function($) {
    ...
    $(document).ready(function() {
        ...
        if (!isMobile.any()) {
            ...
            [].forEach.call(
                document.querySelectorAll(".modified-accordion .collapse"),
                function(e) {
        ...
        if (!isMobile.any()) {
            [].forEach.call(
                document.querySelectorAll("[data-emoji-form]"),
                function(form) {
            ...
            [].forEach.call(
                document.querySelectorAll("[data-emoji-form]"),
                function(form) {
                    form.querySelector("[data-emoji-btn]").style.display =
                        "none";
                }
            );
        }
        ...
        [].forEach.call(
            document.querySelectorAll('[data-chat="open"]'),
            function(a) {
                a.addEventListener(
                    "click",
                    function() {
        ...
        [].forEach.call(
            ...
            function(e) {
                e.addEventListener("click", function(event) {
                    event.preventDefault();
                    var chat_sidebar_id = e.getAttribute(
                        "data-chat"
                    );
        ...
        if (document.querySelector("#dropzone-template-js")) {
            ...
            var template_element = document.querySelector(
        ...
        [].forEach.call(
            document.querySelectorAll(".dropzone-form-js"),
            function(el) {
                var clickable = el.querySelector(".dropzone-button-js").id;
                var url = el.getAttribute("data-dz-url");
                var previewsContainer = el.querySelector(
                    ".dropzone-previews-js"
                );
